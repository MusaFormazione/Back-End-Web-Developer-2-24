...
class Auth extends Connection{
    ...
    /**
     * Register a new user
     * @param array $data Dati per la registrazione dell'utente (es. $_POST)
     * @return void
     */
    public function register(array $data): void{
        ...
        try{
            ...
            $sql = "INSERT INTO utenti (nome, cognome, email, ruoloId, password_hash) VALUE (:nome, :cognome, :email, :ruoloId, :password_hash)";
            ...
            $query->bindParam(':ruoloId',$ruoloId);
            ...
            ErrorHelper::setSessionMessage('Utente registrato con successo!',BASE_URL . $this->loginRoute);
    ...
    /**
     * Logs a new user in
     * @param array $data Dati per il login dell'utente (es. $_POST)
     * @return void
     */
    public function login(array $data): void{
        ...
        [
            ...
            ErrorHelper::setSessionMessage("Accesso effettuato come {$utente['nome']}", BASE_URL . $this->dashBoardRoute);
    ...
    public function requireGuest(string $redirectUrl = ''){
        $redirectUrl = $redirectUrl ?? $this->dashBoardRoute;
        if($this->isLoggedIn()){
