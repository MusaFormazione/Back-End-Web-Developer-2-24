...
$file = "$folder/file-creato.txt";//Tieni presente che il nome del file in realtà può comprendere anche il percorso dove questo file si troverà 
...
//Il secondo parametro (w) definisce che stiamo aprendo un file in scrittura. (Sovrascrivere il file se questo contiene già dei dati)

if(!$fileHandle) die('Impossibile aprire il file');


if(fwrite($fileHandle,'Ciao Mondo!')){
